    ...
    <div className="rounded-xl border border-zinc-200 bg-white p-4">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate font-semibold text-zinc-950">{progress.member.profile?.full_name || 'Member'}</p>
          <p className="text-xs text-zinc-400">{progress.member.role}</p>
        </div>
        <div className="flex items-center gap-1 rounded-md bg-zinc-100 px-2 py-1 text-xs font-medium text-zinc-600">
      ...
      {progress.dayComplete ? (
        <div className="mt-3 flex items-center gap-2 text-xs font-medium text-zinc-600">
